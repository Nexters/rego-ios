...
struct Mock {
   ...
   static let detailGameMock: [FetchDetailGamesModel] = [
        ...
        FetchDetailGamesModel(gameUUID: "포스터 조각 보고 맞추기", title: "포스터 조각 보고 맞추기", gameDescription: "포스터 조각만 보고 어떤 영화인지 맞추는 게임", iconType: .SONG, tag: [.속도가생명, .팀대항전, .팀대항전], uiType: .TEXT_TYPE, like: true, likeCount: 400)
